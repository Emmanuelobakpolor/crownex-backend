...
# Logging — plain console output so errors (e.g. Quidax/Flutterwave/PluginNG
# failures) actually show up in Railway's captured logs instead of relying
# on Python's implicit last-resort stderr handler.
LOGGING = {
    'version': 1,
